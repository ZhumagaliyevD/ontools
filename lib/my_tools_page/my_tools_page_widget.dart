    ...
    return StreamBuilder<List<ToolsRecord>>(
      stream: queryToolsRecord(
        queryBuilder: (toolsRecord) =>
            toolsRecord.where('created_by', isEqualTo: currentUserReference),
      ),
      builder: (context, snapshot) {
        ...
        List<ToolsRecord> myToolsPageToolsRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                      ...
                      child: StreamBuilder<List<ToolsRecord>>(
                        stream: queryToolsRecord(
                          queryBuilder: (toolsRecord) => toolsRecord
                              ...
                              .where('ToolName',
                                  isEqualTo: FFAppState().filterToolName),
                        ),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                    ...
                    if (FFAppState().filterToolName == null ||
                        FFAppState().filterToolName == '')
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(12, 12, 12, 12),
                        child: StreamBuilder<List<ToolsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<ToolsRecord> fullToolListToolsRecordList =
                                snapshot.data!;
                            return ListView.builder(
                              padding: EdgeInsets.zero,
                              primary: false,
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
                              itemCount: fullToolListToolsRecordList.length,
                              itemBuilder: (context, fullToolListIndex) {
                                final fullToolListToolsRecord =
                                    fullToolListToolsRecordList[
                                        fullToolListIndex];
                                return Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    InkWell(
                                      onTap: () async {
                                        setState(() => FFAppState()
                                                .toolBuyDate =
                                            fullToolListToolsRecord.buyDate);
                                        setState(() => FFAppState().toolimg =
                                            fullToolListToolsRecord.photo!);
                                        setState(() => FFAppState().chequeName =
                                            fullToolListToolsRecord
                                                .chequeName!);
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                        '${fullToolListToolsRecord.price?.toString()} \$',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyText1,
