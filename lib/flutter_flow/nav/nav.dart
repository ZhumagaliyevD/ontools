...
class AppStateNotifier extends ChangeNotifier {
  OnToolsFirebaseUser? initialUser;
  OnToolsFirebaseUser? user;
  ...
  void update(OnToolsFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'ContinueSignupPage',
              path: 'continueSignupPage',
              requireAuth: true,
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'MyToolsPage')
                  : MyToolsPageWidget(),
            ),
            FFRoute(
              name: 'AddNewToolPage',
              path: 'addNewToolPage',
              requireAuth: true,
              builder: (context, params) => AddNewToolPageWidget(),
            ),
            FFRoute(
              name: 'EditToolPage',
              path: 'editToolPage',
