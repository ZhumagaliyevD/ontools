...
class _SignUpPageWidgetState extends State<SignUpPageWidget> {
  ...
  void initState() {
    super.initState();
    confPasswordSignUpController = TextEditingController();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            confPasswordSignUpController,
                                        obscureText:
                                            !confPasswordSignUpVisibility,
                                        decoration: InputDecoration(
                                          labelText: FFLocalizations.of(context)
                                              .getText(
                                            'w7i7e64i' /* Введите пароль */,
                                          ),
                                          enabledBorder: OutlineInputBorder(
                                            borderSide: BorderSide(
                                              color:
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          context.pushNamedAuth(
                                              'ContinueSignupPage', mounted);
                                        },
                                        text:
                                            FFLocalizations.of(context).getText(
                                          'hp4cd48t' /* Создать аккаунт */,
                                        ),
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '11mxs9rw' /* Нажимая кнопку Создать аккаунт... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyText1
                                            .override(
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'lgxnxeua' /* Нажимая кнопку Создать аккаунт... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyText1
                                            .override(
                                    ...
                                    InkWell(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'eoqrrcll' /* Политикой конфиденциальности и */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyText1
                                            .override(
                                    ...
                                    InkWell(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '67fgmcmv' /* Пользовательским соглашением */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyText1
                                            .override(
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'g1rvyn1e' /* У Вас есть аккаунт? Войти */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyText1
                                              .override(
